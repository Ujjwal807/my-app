...
function CounterContainer({ content }) {
  ...
  return (
    <div className="flex min-[320px]:h-full items-center justify-between min-[320px]:flex-wrap min-[320px]:gap-4 min-[320px]:w-full max-w-screen-lg bg-gray-400/20 backdrop-blur-lg rounded-lg sm:w-full sm:mt-0  py-2 px-4 lg:w-9/12  mt-4 mx-5 ">
